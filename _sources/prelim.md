...
<!-- If $a \equiv b \text{ mod } m$ then $b$ is called a residue of $a$ modulo $m$. 
 -->
...
We also note that the totient function is a multiplicative function i.e., $\phi(mn) = \phi(m)\phi(n)$ (proof omitted here).
